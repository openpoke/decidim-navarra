...
ActiveRecord::Schema.define(version: 20_240_516_112_056) do
  ...
  create_table 'decidim_amendments', force: :cascade do |t|
    ...
    t.index %w[decidim_user_id decidim_amendable_id decidim_amendable_type],
  ...
  create_table 'decidim_assembly_user_roles', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[decidim_assembly_id decidim_user_id role], name: 'index_unique_user_and_assembly_role',
                                                          unique: true
  ...
  create_table 'decidim_attachment_collections', force: :cascade do |t|
    ...
    t.index %w[collection_for_type collection_for_id],
            name: 'decidim_attachment_collections_collection_for_id_and_type'
  end
  ...
  create_table 'decidim_awesome_config', force: :cascade do |t|
    ...
    t.index %w[var decidim_organization_id], name: 'index_decidim_awesome_organization_var', unique: true
  end
  ...
  create_table 'decidim_awesome_config_constraints', force: :cascade do |t|
    ...
    t.index %w[settings decidim_awesome_config_id], name: 'index_decidim_awesome_settings_awesome_config',
                                                    unique: true
  end
  ...
  create_table 'decidim_budgets_line_items', id: :serial, force: :cascade do |t|
    ...
    t.index %w[decidim_order_id decidim_project_id], name: 'decidim_budgets_line_items_order_project_unique',
                                                     unique: true
  ...
  create_table 'decidim_categories', id: :serial, force: :cascade do |t|
    ...
    t.integer 'weight', default: 0, null: false
    t.index %w[decidim_participatory_space_id decidim_participatory_space_type],
  ...
  create_table 'decidim_comments_comment_votes', id: :serial, force: :cascade do |t|
    ...
    t.index %w[decidim_comment_id decidim_author_id], name: 'decidim_comments_comment_vote_comment_author_unique',
                                                      unique: true
  ...
  create_table 'decidim_comments_comments', id: :serial, force: :cascade do |t|
    ...
    t.index %w[decidim_root_commentable_type decidim_root_commentable_id],
  ...
  create_table 'decidim_components', id: :serial, force: :cascade do |t|
    ...
    t.index %w[participatory_space_id participatory_space_type],
  ...
  create_table 'decidim_conference_user_roles', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[decidim_conference_id decidim_user_id role], name: 'index_unique_user_and_conference_role',
                                                            unique: true
  end
  ...
  create_table 'decidim_conferences', force: :cascade do |t|
    ...
    t.integer 'follows_count', default: 0, null: false
    t.index %w[decidim_organization_id slug], name: 'index_unique_conference_slug_and_organization', unique: true
  ...
  create_table 'decidim_conferences_conference_registrations', force: :cascade do |t|
    ...
    t.index %w[decidim_user_id decidim_conference_id],
            name: 'decidim_conferences_registrations_user_conference_unique', unique: true
  ...
  create_table 'decidim_consultations', force: :cascade do |t|
    ...
    t.index %w[decidim_organization_id slug], name: 'index_unique_consultation_slug_and_organization', unique: true
  ...
  create_table 'decidim_consultations_questions', force: :cascade do |t|
    ...
    t.index %w[decidim_organization_id slug], name: 'index_unique_question_slug_and_organization', unique: true
  ...
  create_table 'decidim_consultations_response_groups', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index ['decidim_consultations_questions_id'],
            name: 'index_consultations_response_groups_on_consultation_questions'
  end
  ...
  create_table 'decidim_consultations_responses', force: :cascade do |t|
    ...
    t.index ['decidim_consultations_response_group_id'],
            name: 'index_consultations_response_groups_on_consultation_responses'
  end
  ...
  create_table 'decidim_consultations_votes', force: :cascade do |t|
    ...
    t.index %w[decidim_consultation_question_id decidim_author_id decidim_user_group_id],
            name: 'index_question_votes_author_unique', unique: true
  ...
  create_table 'decidim_content_blocks', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[decidim_organization_id scope_name scoped_resource_id manifest_name],
  ...
  create_table 'decidim_endorsements', force: :cascade do |t|
    ...
    t.index %w[resource_type resource_id decidim_author_type decidim_author_id decidim_user_group_id],
  ...
  create_table 'decidim_follows', force: :cascade do |t|
    ...
    t.index %w[decidim_user_id decidim_followable_id decidim_followable_type],
            name: 'index_uniq_on_follows_user_and_followable', unique: true
  ...
  create_table 'decidim_forms_questionnaires', id: :serial, force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.string 'salt'
    t.index %w[questionnaire_for_type questionnaire_for_id],
            name: 'index_decidim_forms_questionnaires_questionnaire_for'
  end
  ...
  create_table 'decidim_identities', id: :serial, force: :cascade do |t|
    ...
    t.index %w[provider uid decidim_organization_id],
            name: 'decidim_identities_provider_uid_organization_unique', unique: true
  end
  ...
  create_table 'decidim_initiatives', force: :cascade do |t|
    ...
    t.index %w[decidim_author_id decidim_author_type], name: 'index_decidim_initiatives_on_decidim_author'
  ...
  create_table 'decidim_meetings_questionnaires', force: :cascade do |t|
    ...
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[questionnaire_for_type questionnaire_for_id],
            name: 'index_decidim_meetings_questionnaires_questionnaire_for'
  end
  ...
  create_table 'decidim_meetings_registrations', force: :cascade do |t|
    ...
    t.index %w[decidim_user_id decidim_meeting_id], name: 'decidim_meetings_registrations_user_meeting_unique',
                                                    unique: true
  ...
  create_table 'decidim_metrics', force: :cascade do |t|
    ...
    t.index %w[day metric_type decidim_organization_id participatory_space_type participatory_space_id related_object_type related_object_id decidim_category_id],
            name: 'idx_metric_by_day_type_org_space_object_category', unique: true
    ...
    t.index %w[participatory_space_type participatory_space_id],
            name: 'index_metric_on_participatory_space_id_and_type'
  ...
  create_table 'decidim_participatory_process_steps', id: :serial, force: :cascade do |t|
    ...
    t.string 'cta_path'
    t.index %w[decidim_participatory_process_id active], name: 'unique_index_to_avoid_duplicate_active_steps',
  ...
  create_table 'decidim_participatory_process_user_roles', id: :serial, force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[decidim_participatory_process_id decidim_user_id role],
            name: 'index_unique_user_and_process_role', unique: true
  ...
  create_table 'decidim_proposals_collaborative_draft_collaborator_requests', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index ['decidim_proposals_collaborative_draft_id'],
  ...
  create_table 'decidim_proposals_proposal_votes', id: :serial, force: :cascade do |t|
    ...
    t.index %w[decidim_proposal_id decidim_author_id],
            name: 'decidim_proposals_proposal_vote_proposal_author_unique', unique: true
  ...
  create_table 'decidim_reminder_records', force: :cascade do |t|
    ...
    t.index %w[remindable_type remindable_id], name: 'index_decidim_reminder_records_remindable'
  ...
  create_table 'decidim_resource_permissions', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[resource_type resource_id], name: 'index_decidim_resource_permissions_on_r_type_and_r_id',
                                           unique: true
  end
  ...
  create_table 'decidim_scopes', id: :serial, force: :cascade do |t|
    ...
    t.index %w[decidim_organization_id code], name: 'index_decidim_scopes_on_decidim_organization_id_and_code',
                                              unique: true
  ...
  create_table 'decidim_searchable_resources', force: :cascade do |t|
    ...
    t.index %w[decidim_participatory_space_type decidim_participatory_space_id],
            name: 'index_decidim_searchable_resource_on_pspace_type_and_pspace_id'
  ...
  create_table 'decidim_short_links', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[decidim_organization_id identifier], name: 'idx_decidim_short_links_organization_id_identifier',
                                                    unique: true
    ...
    t.index %w[target_type target_id], name: 'index_decidim_short_links_on_target'
  end
  ...
  create_table 'decidim_templates_templates', force: :cascade do |t|
    ...
    t.index %w[templatable_type templatable_id], name: 'index_decidim_templates_templatable'
  end
  ...
  create_table 'decidim_term_customizer_constraints', force: :cascade do |t|
    ...
    t.index %w[subject_type subject_id], name: 'decidim_term_customizer_constraint_subject'
  ...
  create_table 'decidim_user_group_memberships', id: :serial, force: :cascade do |t|
    ...
    t.index %w[decidim_user_id decidim_user_group_id],
            name: 'decidim_user_group_memberships_unique_user_and_group_ids', unique: true
    t.index ['decidim_user_id'], name: 'index_decidim_user_group_memberships_on_decidim_user_id'
    t.index %w[role decidim_user_group_id], name: 'decidim_group_membership_one_creator_per_group', unique: true,
                                            where: "((role)::text = 'creator'::text)"
  end
  ...
  create_table 'decidim_users', id: :serial, force: :cascade do |t|
    ...
    t.index %w[email decidim_organization_id], name: 'index_decidim_users_on_email_and_decidim_organization_id',
                                               unique: true, where: "((deleted_at IS NULL) AND (managed = false) AND ((type)::text = 'Decidim::User'::text))"
    ...
    t.index %w[nickname decidim_organization_id],
            name: 'index_decidim_users_on_nickame_and_decidim_organization_id', unique: true, where: '((deleted_at IS NULL) AND (managed = false))'
  ...
  add_foreign_key 'decidim_attachments', 'decidim_attachment_collections', column: 'attachment_collection_id',
                                                                           name: 'fk_decidim_attachments_attachment_collection_id', on_delete: :nullify
  ...
  add_foreign_key 'decidim_consultations_response_groups', 'decidim_consultations_questions',
                  column: 'decidim_consultations_questions_id'
  add_foreign_key 'decidim_consultations_responses', 'decidim_consultations_questions',
                  column: 'decidim_consultations_questions_id'
  ...
  add_foreign_key 'decidim_term_customizer_constraints', 'decidim_term_customizer_translation_sets',
                  column: 'translation_set_id'
  add_foreign_key 'decidim_term_customizer_translations', 'decidim_term_customizer_translation_sets',
                  column: 'translation_set_id'
