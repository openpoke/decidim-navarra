...
class RenameFeaturesToComponentsAtSurveys < ActiveRecord::Migration[5.1]
  def change
    ...
    return unless index_name_exists?(:decidim_surveys_surveys, 'index_decidim_surveys_surveys_on_decidim_feature_id')

    rename_index :decidim_surveys_surveys, 'index_decidim_surveys_surveys_on_decidim_feature_id',
