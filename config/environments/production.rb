...
Rails.application.configure do
  ...
  config.force_ssl = ENV.fetch("DECIDIM_FORCE_SSL", "false")
  ...
  config.deface.enabled = ENV["DB_ADAPTER"].blank? || ENV.fetch("DB_ADAPTER") == "postgresql" if config.respond_to?(:deface)
end
